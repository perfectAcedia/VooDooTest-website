(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const c of i.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&r(c)}).observe(document,{childList:!0,subtree:!0});function t(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(o){if(o.ep)return;o.ep=!0;const i=t(o);fetch(o.href,i)}})();async function H(){try{const e=await fetch("https://voodoo-sandbox.myshopify.com/products.json");if(!e.ok)throw new Error("Network response was not ok");return await e.json()}catch(e){throw console.error("Error fetching data:",e),e}}function a(e){return Math.round(Number(e)*100)/100}function M(e){const n=document.getElementById("info"),t="Important info",r="Important info regarding our services";e>=1024?n.innerHTML=r:n.innerHTML=t}const p=cart.querySelector("#footer").querySelector("#totalPrice").querySelector("#quantity");function P(e){const n=document.getElementById("cartList"),t=document.createElement("article"),r=e.title,o=e.images[0],i=a(e.variants[0].price),c=e.id;t.classList.add("flex","justify-start","gap-[18px]","relative"),t.setAttribute("id",c),t.innerHTML=`
    ...
    <button id="trash" name="trash" class="absolute top-0 right-0">
        <img src="/trash-icon.svg" alt="trash icon" />
            ...
            `,f.appendChild(v);const h=document.querySelector(`[data-id='${u.id}']`);h.addEventListener("click",()=>{const d=n.find(T=>T.id===+h.dataset.id);if(!L.has(d.id)){L.set(d.id,d);const T=L.get(d.id);P(T),k(d),R(d),D(d,h),q.innerHTML=a(+q.innerHTML+ +d.variants[0].price)}h.setAttribute("disabled","")})})}function i(l){const s=document.getElementById("links");s.innerHTML="",j(l).forEach(f=>{const y=c(f);s.appendChild(y)})}function c(l){const s=document.createElement("li");return s.classList.add("cursor-pointer","text-lg","font-normal","border","rounded-full","w-[39px]","h-[39px]","flex","justify-center","items-center"),s.textContent=l,t===l&&(s.classList.add("text-white","bg-black"),s.setAttribute("id","active")),s.addEventListener("click",()=>{t=l,o(n,r,t),i(t),s.classList.add("text-white","bg-black"),s.setAttribute("id","active")}),s}o(n,r,t),i(t)}function N(e){L.delete(+e)}const W=document.getElementById("cartButton"),K=document.getElementById("arrowDown"),m=document.getElementById("sideMenu"),z=document.getElementById("closeButton"),x=document.getElementById("important"),E=document.getElementById("importantInfo");let w=!1;M(window.innerWidth);A();W.addEventListener("click",()=>{m.classList.remove("translate-x-full"),m.classList.add("translate-x-0"),window.innerWidth>=1024?m.style.width="25%":m.style.width="100%"});K.addEventListener("click",()=>{w?(x.classList.add("bottom-0"),x.classList.remove("-bottom-[70px]"),E.classList.remove("flex"),E.classList.add("hidden"),w=!1):(x.classList.remove("bottom-0"),x.classList.add("-bottom-[70px]"),E.classList.remove("hidden"),E.classList.add("flex"),w=!0)});z.addEventListener("click",()=>{m.classList.remove("translate-x-0"),m.classList.add("translate-x-full")});window.addEventListener("resize",e=>{const n=e.currentTarget.innerWidth;M(n)});
