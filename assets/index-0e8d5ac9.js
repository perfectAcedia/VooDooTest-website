(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const c of i.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&r(c)}).observe(document,{childList:!0,subtree:!0});function t(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(o){if(o.ep)return;o.ep=!0;const i=t(o);fetch(o.href,i)}})();async function P(){try{const e=await fetch("https://voodoo-sandbox.myshopify.com/products.json");if(!e.ok)throw new Error("Network response was not ok");return await e.json()}catch(e){throw console.error("Error fetching data:",e),e}}function a(e){return Math.round(Number(e)*100)/100}function S(e){const n=document.getElementById("info"),t="Important info",r="Important info regarding our services";e>=1024?n.innerHTML=r:n.innerHTML=t}const p=cart.querySelector("#footer").querySelector("#totalPrice").querySelector("#quantity");function C(e){const n=document.getElementById("cartList"),t=document.createElement("article"),r=e.title,o=e.images[0],i=a(e.variants[0].price),c=e.id;t.classList.add("flex","justify-start","gap-[18px]","relative"),t.setAttribute("id",c),t.innerHTML=`
    ...
    <button id="trash" name="trash" class="absolute top-0 right-0 hover:scale-110 duration-300">
        <img src="trash-icon.svg" alt="trash icon" />
            ...
            `,f.appendChild(v);const y=document.querySelector(`[data-id='${u.id}']`);y.addEventListener("click",()=>{const d=n.find(w=>w.id===+y.dataset.id);if(!g.has(d.id)){g.set(d.id,d);const w=g.get(d.id);C(w),R(d),A(d),k(d,y),q.innerHTML=a(+q.innerHTML+ +d.variants[0].price)}y.setAttribute("disabled","")})})}function i(l){const s=document.getElementById("links");s.innerHTML="",j(l).forEach(f=>{const h=c(f);s.appendChild(h)})}function c(l){const s=document.createElement("li");return s.classList.add("cursor-pointer","text-lg","font-normal","border","rounded-full","w-[39px]","h-[39px]","flex","justify-center","items-center","hover:scale-110","duration-300"),s.textContent=l,t===l&&(s.classList.add("text-white","bg-black"),s.setAttribute("id","active")),s.addEventListener("click",()=>{t=l,o(n,r,t),i(t),s.classList.add("text-white","bg-black"),s.setAttribute("id","active")}),s}o(n,r,t),i(t)}function W(e){g.delete(+e)}const K=document.getElementById("cartButton"),z=document.getElementById("arrowDown"),E=document.getElementById("arrowIcon"),m=document.getElementById("sideMenu"),U=document.getElementById("closeButton"),M=document.getElementById("important"),L=document.getElementById("importantInfo");let T=!1;S(window.innerWidth);N();K.addEventListener("click",()=>{m.classList.remove("translate-x-full"),m.classList.add("translate-x-0"),window.innerWidth>=1024?m.style.width="25%":m.style.width="100%"});z.addEventListener("click",()=>{T?(M.style.bottom="0",L.classList.remove("flex"),L.classList.add("hidden"),E.classList.remove("rotate-180"),E.classList.add("rotate-0"),T=!1):(M.style.bottom="-65px",L.classList.remove("hidden"),L.classList.add("flex"),E.classList.remove("rotate-0"),E.classList.add("rotate-180"),T=!0)});U.addEventListener("click",()=>{m.classList.remove("translate-x-0"),m.classList.add("translate-x-full")});window.addEventListener("resize",e=>{const n=e.currentTarget.innerWidth;S(n)});
